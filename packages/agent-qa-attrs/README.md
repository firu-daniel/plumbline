...
```tsx
import { qaAttr } from '@straightedge/agent-qa-attrs';
...
```tsx
import { QaScope, useQaAttr } from '@straightedge/agent-qa-attrs';
...
```ts
import { qaSelector } from '@straightedge/agent-qa-attrs/core';
